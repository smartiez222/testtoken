    ...
    init: function (flag) {
            ...
            tables.forEach(function (table) {
                ...
                rows.forEach(row => {
                    ...
                    highlightIndices.forEach(index => {
                        ...
                        contentMap[content].push(actualElement);
                    }
                    );
                }
                );
        ...
        ; function doMouseEnter() {
            ...
            if (!(content.startsWith("Create: ") || content.startsWith("Contract Creation"))) {
                try {
                    contentMap[content].forEach(matchingElement => {
        ...
        function deserializeSettings() {
            const decodedCookie = getCookie("etherscan_isHighlight");
